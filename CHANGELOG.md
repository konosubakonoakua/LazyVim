...
## [13.0.0](https://github.com/konosubakonoakua/LazyVim/compare/v12.12.0...v13.0.0) (2024-06-11)
...
* **dot:** add bashls and shellcheck ([#2879](https://github.com/konosubakonoakua/LazyVim/issues/2879)) ([97480dc](https://github.com/konosubakonoakua/LazyVim/commit/97480dc5d2dbb717b45a351e0b04835f138a9094))
* **dot:** add more filetypes ([#2987](https://github.com/konosubakonoakua/LazyVim/issues/2987)) ([15b09e8](https://github.com/konosubakonoakua/LazyVim/commit/15b09e800ba7fb0c9ca8270a77e71083396e9db1))
...
* **extras:** add refactoring.nvim ([#3040](https://github.com/konosubakonoakua/LazyVim/issues/3040)) ([73de8dd](https://github.com/konosubakonoakua/LazyVim/commit/73de8dde2bb513337426d5ead862e4fc6dbb8fdf))
...
* **extras:** added extra for mini.diff ([e29c7ac](https://github.com/konosubakonoakua/LazyVim/commit/e29c7acd2d149da8166f2f44c920cc7d5c89971a))
...
* **extras:** added extra for the `trouble.nvim` v3 beta ([bb6aa98](https://github.com/konosubakonoakua/LazyVim/commit/bb6aa98cbfe0547150be89dc42f35e3b3eef8b5d))
...
* **extras:** use mini.move instead of native move ([#2865](https://github.com/konosubakonoakua/LazyVim/issues/2865)) ([8f1fb60](https://github.com/konosubakonoakua/LazyVim/commit/8f1fb60f0a78cb2e83b485e1f946822812c5ff50))
...
* **git:** `&lt;leader&gt;gb` for Git Blame Line ([9e3af10](https://github.com/konosubakonoakua/LazyVim/commit/9e3af1070fc1932da322105708ebb32a2cd9572b))
...
* **lualine:** make path trimming configurable by user ([#3062](https://github.com/konosubakonoakua/LazyVim/issues/3062)) ([b8475f5](https://github.com/konosubakonoakua/LazyVim/commit/b8475f51949acf195729a1c4d057a06208a9add9))
...
* **mason-lspconfig:** allow `opts.ensure_installed` to be taken into account ([#3134](https://github.com/konosubakonoakua/LazyVim/issues/3134)) ([8968c9e](https://github.com/konosubakonoakua/LazyVim/commit/8968c9e9ea76f3a7616d9e249a3c9307a75fffad))
...
* **pick:** add function for searching `plugin_files` ([e4174d0](https://github.com/konosubakonoakua/LazyVim/commit/e4174d01a6616b915d571981cd98f85b77fd535d))
...
* **python:** use new `ruff` instead of `ruff_lsp` ([#3016](https://github.com/konosubakonoakua/LazyVim/issues/3016)) ([cd04b58](https://github.com/konosubakonoakua/LazyVim/commit/cd04b58fe3f7299fbca75e7eb47287617ac23fcf))
...
* **trouble:** added `&lt;leader&gt;cS` to open a trouble list of all references / definitions / ... of the item under the cursor ([7544675](https://github.com/konosubakonoakua/LazyVim/commit/754467525b420c85150f13b2cd9e280570c7556c))
* **trouble:** enabled edgy ([80a8b18](https://github.com/konosubakonoakua/LazyVim/commit/80a8b18be6577dcea35748eb563ebef7cf1b3c15))
...
* **vue:** add Vue.js support to LazyVim ([#3094](https://github.com/konosubakonoakua/LazyVim/issues/3094)) ([f449025](https://github.com/konosubakonoakua/LazyVim/commit/f4490252fb2262208923ba197eb521732a602ac1))
...
* **ansible:** ansiblels not loading, keymap desc. ([#2739](https://github.com/konosubakonoakua/LazyVim/issues/2739)) ([abb1ff0](https://github.com/konosubakonoakua/LazyVim/commit/abb1ff0d600b3446b612390f0482cf92bdc84ab0))
...
* **clangd:** update the attribute name for process ID ([#3047](https://github.com/konosubakonoakua/LazyVim/issues/3047)) ([3c04789](https://github.com/konosubakonoakua/LazyVim/commit/3c04789ef15bba15e8c0c71ef31db38c76b2ad67))
...
* **dial:** Fix dial commands in Visual line+block ([#2933](https://github.com/konosubakonoakua/LazyVim/issues/2933)) ([1df3c5d](https://github.com/konosubakonoakua/LazyVim/commit/1df3c5d70b2265f8582b0ed414f085e9066960da))
...
* **dot:** can't match kitty conf file ([#3042](https://github.com/konosubakonoakua/LazyVim/issues/3042)) ([5fb4cf0](https://github.com/konosubakonoakua/LazyVim/commit/5fb4cf0d365b65cb9b7afa8be047973b5fc1747a))
* **dot:** install when list is empty ([#3052](https://github.com/konosubakonoakua/LazyVim/issues/3052)) ([3086bf0](https://github.com/konosubakonoakua/LazyVim/commit/3086bf03e96bfc0048e5b27f8d65a9170bca3f67))
* **dot:** remove `.env` =&gt; `sh` since this is already the default ([a0afe8f](https://github.com/konosubakonoakua/LazyVim/commit/a0afe8fef9dc76b469a78435cdd3f2c5ee01f282))
* **dot:** use syntax `sh` for dotenv files. Closes [#3145](https://github.com/konosubakonoakua/LazyVim/issues/3145) ([42010d1](https://github.com/konosubakonoakua/LazyVim/commit/42010d1dfbb0ba9c74c1ec0c93c5c9db21ebee47))
...
* **edgy:** proper way of opening neo-tree. Fixes [#2984](https://github.com/konosubakonoakua/LazyVim/issues/2984) ([6fdbc62](https://github.com/konosubakonoakua/LazyVim/commit/6fdbc623e0a59220e754800df3b86788eca0813d))
...
* **extras:** Rust-Analyzer cargo option ([#3061](https://github.com/konosubakonoakua/LazyVim/issues/3061)) ([a96348d](https://github.com/konosubakonoakua/LazyVim/commit/a96348d7b076819f7580ea0c0ce467630bfc7cc5))
...
* **fzf-native:** try rebuilding fzf-native when needed. Fixes [#2464](https://github.com/konosubakonoakua/LazyVim/issues/2464) ([39901c1](https://github.com/konosubakonoakua/LazyVim/commit/39901c1f00eca36beb211978164744ae41be7781))
...
* **harpoon:** harpoon2 deprecated message  ([#2920](https://github.com/konosubakonoakua/LazyVim/issues/2920)) ([79fed97](https://github.com/konosubakonoakua/LazyVim/commit/79fed97f2357b2969cb23d106137978ca7cdffb4))
* **harpoon:** optimizes harpoon keys ([#2877](https://github.com/konosubakonoakua/LazyVim/issues/2877)) ([50b7f42](https://github.com/konosubakonoakua/LazyVim/commit/50b7f426f287ecfc542dd9c197e430b0aca8af04))
...
* **lazyfile:** exclude `filetypedetect` from skips ([#3004](https://github.com/konosubakonoakua/LazyVim/issues/3004)) ([c54eeb5](https://github.com/konosubakonoakua/LazyVim/commit/c54eeb53905e8da27814f52eaf1ad63aeff4cbe4))
...
* **lsp:** better support for diagnostics icons on Neovim nightly/stable ([aaa10e7](https://github.com/konosubakonoakua/LazyVim/commit/aaa10e717dbe76c5b6b0ab302698f1d151863dc6))
...
* **lsp:** check if `diagnostics.signs` is disabled by user ([#2897](https://github.com/konosubakonoakua/LazyVim/issues/2897)) ([6a25450](https://github.com/konosubakonoakua/LazyVim/commit/6a2545025eb6fcc78998b8a4c6d121729980925b))
...
* **lsp:** dont define diagnostics signs on &gt;= 0.10.0 ([64f8614](https://github.com/konosubakonoakua/LazyVim/commit/64f86147f9f4c67548185798f755c80e03c2098a))
...
* merge conflict ([349ae03](https://github.com/konosubakonoakua/LazyVim/commit/349ae03f0997d20aa6b4a23315e62dfeab77d559))
...
* **mini.move:** default mini.move setup already maps the correct keys ([3166236](https://github.com/konosubakonoakua/LazyVim/commit/3166236ff88a13e7e5b7579ae780b682f2356d62))
* **mini.pairs:** better default for ```` ([32eacde](https://github.com/konosubakonoakua/LazyVim/commit/32eacde793fddcca0bcfbbd494b6aa8b2c870d0f))
...
* **native_snippets:** don't try to enable native snippets on Neovim &lt; 0.10.0 and show warning ([f308867](https://github.com/konosubakonoakua/LazyVim/commit/f3088675703986b6d37061ebcf0a417c132fd45f))
* **native_snippets:** Fix native_snippets for `vim.snippet api` changes ([#3083](https://github.com/konosubakonoakua/LazyVim/issues/3083)) ([6004e8d](https://github.com/konosubakonoakua/LazyVim/commit/6004e8d4f60549bd2c5d6f3187a28d72b21e3261))
...
* **neo-tree:** correctly set up `cwd` ([#3097](https://github.com/konosubakonoakua/LazyVim/issues/3097)) ([30ce84f](https://github.com/konosubakonoakua/LazyVim/commit/30ce84f7a7fb4e88b47ddf2f569b2ea9b7d56717))
...
* **pretty_path:** properly escape `%` characters ([e89653f](https://github.com/konosubakonoakua/LazyVim/commit/e89653f4107724f53964a379337947490117a7dc))
...
* **python:** make both `ruff` and `ruff_lsp` available to user ([#3060](https://github.com/konosubakonoakua/LazyVim/issues/3060)) ([34183a2](https://github.com/konosubakonoakua/LazyVim/commit/34183a2759828001b08679659f7d5170d7ec367e))
...
* **rust:** update creates.nvim src option to completion ([#3149](https://github.com/konosubakonoakua/LazyVim/issues/3149)) ([8087283](https://github.com/konosubakonoakua/LazyVim/commit/8087283fea62e5673764dfa13906eadb24110622))
...
* **statuscolumn:** right align signs when virtnum &gt; 0 ([a786c47](https://github.com/konosubakonoakua/LazyVim/commit/a786c471df5c048690618b6ff17fa2bc9648891d))
...
* **tex:** don't override conceallevel for tex. Not sure why that was added ([914f26d](https://github.com/konosubakonoakua/LazyVim/commit/914f26d04e6b9a61f7d4fc80ad433d75dac3f14b))
...
* **toggle:** use new `inlay_hint.enable()` signature ([#3013](https://github.com/konosubakonoakua/LazyVim/issues/3013)) ([5f92dc5](https://github.com/konosubakonoakua/LazyVim/commit/5f92dc5304b99a3e76dca878d9b47557fb64f384))
...
* **trouble_v3:** keymap `previous` is deprecated, use `prev` instead ([#2968](https://github.com/konosubakonoakua/LazyVim/issues/2968)) ([0fa6360](https://github.com/konosubakonoakua/LazyVim/commit/0fa63603afcb9b478c49a54d94314d20af00ae95))
...
* **trouble_v3:** show error only when `trouble_v3` is enabled ([#2989](https://github.com/konosubakonoakua/LazyVim/issues/2989)) ([ceb4855](https://github.com/konosubakonoakua/LazyVim/commit/ceb4855b434c8e7095bbf47cfc3b3647532d6a2c))
...
* **trouble-v3:** fix telescope integration ([9da13ef](https://github.com/konosubakonoakua/LazyVim/commit/9da13ef7e8a0b6c07e8e35f7c93dc77f3408d38b))
* **trouble-v3:** use the filtered symbols list for lualine ([4ca0bf6](https://github.com/konosubakonoakua/LazyVim/commit/4ca0bf69dd1e4a359af6894490f794bd5fc12cf0))
...
* **trouble:** show message if use hasnt updated with Lazy yet after enabling the extra ([9a2f773](https://github.com/konosubakonoakua/LazyVim/commit/9a2f7730907fd9124ec536f8dc2ad0a253f18f36))
...
* **ui:** don't lazy-load dashboard-nvim ([#3107](https://github.com/konosubakonoakua/LazyVim/issues/3107)) ([30c9e47](https://github.com/konosubakonoakua/LazyVim/commit/30c9e4718a127f7d5a32f11c4d8dbba6b01f9858))
...
* **startup:** render a file opened from the cmdline as soon as possible and get rid of lazy_file logic ([965a469](https://github.com/konosubakonoakua/LazyVim/commit/965a469ca8cb1d58b49c4e5d8b85430e8c6c0a25))
* **treesitter:** dont let nvim-treesitter-textobjects stall loading treesitter ([8301096](https://github.com/konosubakonoakua/LazyVim/commit/8301096c31f9855c74d5b732367b679bc8721b5e))
* **treesitter:** load treesitter early during startup when opening a file from the cmdline ([b29d169](https://github.com/konosubakonoakua/LazyVim/commit/b29d169afb7560ed4a9276e4379e28ffaed1a171))
* **yanky:** `schedule_wrap` sqlite push to history to prevent blocking Neovim on copy/paste ([9047d04](https://github.com/konosubakonoakua/LazyVim/commit/9047d041a8296e34ed7236e5344f5b927cd28f8b))
